...
operator fun Vec3i.div(other: Vec3i): Vec3 = Vec3(this.x.toDouble() / other.x, this.y.toDouble() / other.y, this.z.toDouble() / other.z)
...
operator fun Vec3i.plus(other: RelativeLocation): RelativeLocation = RelativeLocation(this.x + other.x, this.y + other.y, this.z + other.z)
...
operator fun Vec3i.minus(other: RelativeLocation): RelativeLocation = RelativeLocation(this.x - other.x, this.y - other.y, this.z - other.z)
...
operator fun Vec3i.times(other: RelativeLocation): RelativeLocation = RelativeLocation(this.x * other.x, this.y * other.y, this.z * other.z)
...
operator fun Vec3i.div(other: RelativeLocation): RelativeLocation = RelativeLocation(this.x / other.x, this.y / other.y, this.z / other.z)
...
operator fun Vec3i.div(scalar: Int): Vec3 = Vec3(this.x.toDouble() / scalar, this.y.toDouble() / scalar, this.z.toDouble() / scalar)
...
fun Vec3i.offsetRandomlyHorizontal(offset: Double, random: Random): Vec3 = asVec3().offsetRandomlyHorizontal(offset, random)
fun Vec3i.offsetRandomlyHorizontal(offset: Double, random: java.util.Random): Vec3 = asVec3().offsetRandomlyHorizontal(offset, random)
fun Vec3i.offsetRandomlyHorizontal(offset: Double, random: RandomSource): Vec3 = asVec3().offsetRandomlyHorizontal(offset, random)
